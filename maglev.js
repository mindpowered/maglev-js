...
var maglev_MagLev = $hx_exports["maglev"]["MagLev"] = function() {
	this._listeners = new haxe_ds_StringMap();
	this._methods = new haxe_ds_StringMap();
};
$hxClasses["maglev.MagLev"] = maglev_MagLev;
maglev_MagLev.__name__ = ["maglev","MagLev"];
maglev_MagLev.getInstance = function(key) {
	var _this = maglev_MagLev._instances;
	if(!(__map_reserved[key] != null ? _this.existsReserved(key) : _this.h.hasOwnProperty(key))) {
		var this1 = maglev_MagLev._instances;
		var v = new maglev_MagLev();
		var _this1 = this1;
		if(__map_reserved[key] != null) {
	...
	var _this2 = maglev_MagLev._instances;
	if(__map_reserved[key] != null) {
...
maglev_MagLev.prototype = {
	_methods: null
	,_listeners: null
	,register: function(method,callback) {
		var _this = this._methods;
		if(__map_reserved[method] != null) {
			_this.setReserved(method,callback);
		} else {
			_this.h[method] = callback;
		}
	}
	,call: function(method,args) {
		var _this = this._methods;
		if(__map_reserved[method] != null ? _this.existsReserved(method) : _this.h.hasOwnProperty(method)) {
			var _this1 = this._methods;
			return (__map_reserved[method] != null ? _this1.getReserved(method) : _this1.h[method])(args);
		} else {
			throw new js__$Boot_HaxeError("Method '" + method + "' not registered");
		}
	}
	,listen: function(event,callback) {
		var _this = this._listeners;
		if(!(__map_reserved[event] != null ? _this.existsReserved(event) : _this.h.hasOwnProperty(event))) {
			var this1 = this._listeners;
			var v = [];
			var _this1 = this1;
		...
		var _this2 = this._listeners;
		(__map_reserved[event] != null ? _this2.getReserved(event) : _this2.h[event]).push(callback);
	}
	,emit: function(event,args) {
		var _this = this._listeners;
		if(__map_reserved[event] != null ? _this.existsReserved(event) : _this.h.hasOwnProperty(event)) {
			var _this1 = this._listeners;
			var listeners = __map_reserved[event] != null ? _this1.getReserved(event) : _this1.h[event];
			var _g = 0;
