...
class maglev_MagLevJs {
	...
	register(method,callback) {
		...
		let myfunc = function(args) {
			let arr = [];
			let i = 0;
			while(i < args.size()) arr.push(_gthis.convertToJs(args.get(i)));
			let result = _gthis.convertToMagLev(callback(arr));
	...
	call(method,args) {
		...
		if(myresult.isError()) {
			throw haxe_Exception.thrown(myresult.getError().getMessage());
		} else {
			return this.convertToJs(myresult.getResult());
		}
	}
	listen(event,callback) {
		let _gthis = this;
	...
	convertToJs(x) {
		...
		if(x.getType() == maglev_MagLevType.MagLevType_Null) {
			return null;
		} else if(x.getType() == maglev_MagLevType.MagLevType_Boolean) {
			let y = js_Boot.__cast(x , maglev_MagLevBoolean);
			return y.getBool();
		} else if(x.getType() == maglev_MagLevType.MagLevType_String) {
			let y = js_Boot.__cast(x , maglev_MagLevString);
			return y.getString();
		} else if(x.getType() == maglev_MagLevType.MagLevType_Number) {
			let y = js_Boot.__cast(x , maglev_MagLevNumber);
			return y.getFloat();
		} else if(x.getType() == maglev_MagLevType.MagLevType_Array) {
			let y = js_Boot.__cast(x , maglev_MagLevArray);
			let arr = [];
			let i = 0;
			while(i < y.size()) arr.push(y.get(i));
			return arr;
		} else if(x.getType() == maglev_MagLevType.MagLevType_Object) {
			...
			return obj;
		} else if(x.getType() == maglev_MagLevType.MagLevType_Function) {
	...
	convertToMagLev(x) {
		...
		if(x == null) {
			...
			let myfunc = function(args) {
				...
				while(i < args.size()) arr.push(_gthis.convertToJs(args.get(i)));
				let ret = func(arr);
				return maglev_MagLevResult.fromResult(_gthis.convertToMagLev(ret));
			};
...
class maglev_MagLevOld {
	...
	register(method,callback) {
		...
		let myfunc = function(args) {
			let arr = [];
			let i = 0;
			while(i < args.size()) arr.push(_gthis.convertToHaxe(args.get(i)));
			let result = _gthis.convertToMagLev(callback(arr));
			return maglev_MagLevResult.fromResult(result);
		};
		let mycallback = new maglev_MagLevFunction(myfunc);
	...
	convertToMagLev(x) {
		if(typeof(x) == "string") {
			return new maglev_MagLevString(x);
		} else {
			throw haxe_Exception.thrown("convertToMagLev: unknown type");
		}
	}
	static getInstance(key) {
		let instance = new maglev_MagLevOld(maglev_MagLev.getInstance(key));
		return instance;
	}
}
$hxClasses["maglev.MagLevOld"] = $hx_exports["maglev"]["MagLevOld"] = maglev_MagLevOld;
maglev_MagLevOld.__name__ = "maglev.MagLevOld";
Object.assign(maglev_MagLevOld.prototype, {
	__class__: maglev_MagLevOld
	,maglev: null
});
var maglev_MagLevType = $hxEnums["maglev.MagLevType"] = { __ename__ : "maglev.MagLevType", __constructs__ : ["MagLevType_Result","MagLevType_Error","MagLevType_Function","MagLevType_Object","MagLevType_Array","MagLevType_Number","MagLevType_String","MagLevType_Boolean","MagLevType_Null"]
	,MagLevType_Result: {_hx_index:0,__enum__:"maglev.MagLevType",toString:$estr}
	,MagLevType_Error: {_hx_index:1,__enum__:"maglev.MagLevType",toString:$estr}
	,MagLevType_Function: {_hx_index:2,__enum__:"maglev.MagLevType",toString:$estr}
	,MagLevType_Object: {_hx_index:3,__enum__:"maglev.MagLevType",toString:$estr}
	,MagLevType_Array: {_hx_index:4,__enum__:"maglev.MagLevType",toString:$estr}
	,MagLevType_Number: {_hx_index:5,__enum__:"maglev.MagLevType",toString:$estr}
	,MagLevType_String: {_hx_index:6,__enum__:"maglev.MagLevType",toString:$estr}
	,MagLevType_Boolean: {_hx_index:7,__enum__:"maglev.MagLevType",toString:$estr}
	,MagLevType_Null: {_hx_index:8,__enum__:"maglev.MagLevType",toString:$estr}
};
maglev_MagLevType.__empty_constructs__ = [maglev_MagLevType.MagLevType_Result,maglev_MagLevType.MagLevType_Error,maglev_MagLevType.MagLevType_Function,maglev_MagLevType.MagLevType_Object,maglev_MagLevType.MagLevType_Array,maglev_MagLevType.MagLevType_Number,maglev_MagLevType.MagLevType_String,maglev_MagLevType.MagLevType_Boolean,maglev_MagLevType.MagLevType_Null];
class maglev_MagLevResult {
	constructor() {
		this.result = new maglev_MagLevNull();
		this.error = null;
	}
	isError() {
	...
	static fromResult(res) {
		let result = new maglev_MagLevResult();
